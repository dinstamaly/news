...
from djangonews.rest_conf.main import *
...
SECRET_KEY = 'django-insecure-_9zmai$!&ip@4d&na-r^q!dvfk)*yl4s2&)o(+fqabutxtomqe'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get("POSTGRES_PASSWORD", 'qwe123'),
        'HOST': 'db'
    }
}
